...
const initialTeamsData: TeamData = {
  ...
  "Hospitality Team": [
    ...
    { id: 10, name: "Mishra Ji", imageUrl: "/images/IMG_20250811_175835 - ARPIT MISHRA.jpg", role: "Member", icon: "coffee", colors: { primary: "#1a1a1a", secondary: "#333333", text: "#ffffff", shadow: "rgba(0, 0, 0, 0.5)" } },
