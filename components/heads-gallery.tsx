...
const initialTeamsData: TeamData = {
  ...
  "Publicity & Media Team": [
    { id: 74, name: "Ramneet kaur", imageUrl: "/images/ramneet.png", role: "Member", icon: "megaphone", colors: { primary: "#1a1a1a", secondary: "#333333", text: "#ffffff", shadow: "rgba(0, 0, 0, 0.5)" } },
  ...
  "Design Team": [
    ...
    { id: 361, name: "Kanishk Mutkekar", imageUrl: "/images/kanika.png", role: "Member", icon: "pen-tool", colors: { primary: "#1a1a1a", secondary: "#333333", text: "#ffffff", shadow: "rgba(0, 0, 0, 0.5)" } }
  ],
  "Decor Team": [
